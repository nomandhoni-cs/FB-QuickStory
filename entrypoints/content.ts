  ...
  main() {
    ...
    const handlePageChange = () => {
      ...
      if (currentURL === "https://www.facebook.com/stories/create") {
        ...
        // Wait for the page elements to load using MutationObserver
        const observer = new MutationObserver(() => {
          // Check if the file input is present and ready
          ...
          if (fileInput) {
            ...
            // Disconnect observer once elements are found and modified
            observer.disconnect();
          }
        });
